...
import { getEnterpriseDetailsLoginAction } from '../redux/actions/actions';
...
export default function EnterCompanyCode(props:any) {
  ...
  const handleCompanyCode = async() => {
      ...
      dispatch(getEnterpriseDetailsLoginAction({companyCode,onSuccess: onSuccessCompanyCodeCheck}));
  };
  ...
  return (
    <View style={styles.container}>
      <View style={styles.header}>
        <Text style={styles.headerText1}>Hello! Log in to your account</Text>
